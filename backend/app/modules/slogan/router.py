...
@router.post("/", response_model=SloganInfoSchema,
             dependencies=[Depends(require_permission('slogan:create'))])
...
@router.put("/{slogan_id}", response_model=SloganInfoSchema,
            dependencies=[Depends(require_permission('slogan:edit'))])
...
@router.delete("/{slogan_id}",
               dependencies=[Depends(require_permission('slogan:delete'))])
